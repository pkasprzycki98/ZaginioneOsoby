        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Provices = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OsobaZaginionaId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PlaceId = table.Column<int>(nullable: false),
                    Name = table.Column<string>(nullable: false),
                    Surrname = table.Column<string>(nullable: false),
                    MissingDate = table.Column<DateTime>(nullable: false),
                    Age = table.Column<int>(nullable: false),
                    HairColor = table.Column<string>(nullable: false),
                    Height = table.Column<string>(nullable: false),
                    Descprition = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OsobyZaginione", x => x.OsobaZaginionaId);
                    table.ForeignKey(
